...
> implements EntityApi<TimeSheetEntry<DeSerializersT>, DeSerializersT>
{
  ...
  >(
    deSerializers: DeSerializersT = defaultDeSerializers as any
  ): TimeSheetEntryApi<DeSerializersT> {
  ...
  entityBuilder(): EntityBuilderType<
    ...
    DeSerializersT
  > {
    return entityBuilder<TimeSheetEntry<DeSerializersT>, DeSerializersT>(this);
  }
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
         ...
         */
        TIME_SHEET_DATA_FIELDS: fieldBuilder.buildComplexTypeField(
          'TimeSheetDataFields',
          TimeSheetDataFieldsField,
          false
        ),
