 ...
 */
export class TimeSheetDataFieldsField<
...
> {
  ...
  internalOrder: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('InternalOrder', 'Edm.String', true);
  /**
  ...
  wbsElement: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('WBSElement', 'Edm.String', true);
  /**
  ...
  workItem: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('WorkItem', 'Edm.String', true);
  /**
  ...
  purchaseOrder: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('PurchaseOrder', 'Edm.String', true);
  /**
  ...
  timeSheetNote: OrderableEdmTypeField<
    ...
    true,
    false
  > = this._fieldBuilder.buildEdmTypeField('TimeSheetNote', 'Edm.String', true);
  /**
