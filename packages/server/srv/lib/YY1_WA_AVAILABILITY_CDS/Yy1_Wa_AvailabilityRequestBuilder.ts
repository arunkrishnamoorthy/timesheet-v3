 ...
 */
export class Yy1_Wa_AvailabilityRequestBuilder<
...
> extends RequestBuilder<Yy1_Wa_Availability<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Wa_Availability<T>, T> {
    return new GetAllRequestBuilder<Yy1_Wa_Availability<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Wa_Availability<T>, T>(
      this.entityApi,
      { ID: id }
    );
  }
