 ...
 */
export class P_Scbo_UserRequestBuilder<
...
> extends RequestBuilder<P_Scbo_User<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<P_Scbo_User<T>, T> {
    return new GetAllRequestBuilder<P_Scbo_User<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<P_Scbo_User<T>, T>(this.entityApi, {
      name: name
    });
  }
}
