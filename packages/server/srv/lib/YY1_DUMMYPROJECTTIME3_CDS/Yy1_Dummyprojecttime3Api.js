...
exports.Yy1_Dummyprojecttime3Api = void 0;
/*
...
const Yy1_Dummyprojecttime3RequestBuilder_1 = require("./Yy1_Dummyprojecttime3RequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class Yy1_Dummyprojecttime3Api {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = Yy1_Dummyprojecttime3_1.Yy1_Dummyprojecttime3;
    ...
    requestBuilder() {
        return new Yy1_Dummyprojecttime3RequestBuilder_1.Yy1_Dummyprojecttime3RequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(Yy1_Dummyprojecttime3_1.Yy1_Dummyprojecttime3, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SAP_DESCRIPTION: fieldBuilder.buildEdmTypeField('SAP_Description', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                WB_SELEMENT: fieldBuilder.buildEdmTypeField('WBSelement', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                TIMESHEET_TASK_TYPE: fieldBuilder.buildEdmTypeField('TimesheetTaskType', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SENDER_PUB_SEC_FUND: fieldBuilder.buildEdmTypeField('SenderPubSecFund', 'Edm.String', true),
                /**
                 * Static representation of the {@link sendingPubSecFunctionalArea} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SENDING_PUB_SEC_FUNCTIONAL_AREA: fieldBuilder.buildEdmTypeField('SendingPubSecFunctionalArea', 'Edm.String', true),
                /**
                 * Static representation of the {@link senderPubSecGrant} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SENDER_PUB_SEC_GRANT: fieldBuilder.buildEdmTypeField('SenderPubSecGrant', 'Edm.String', true),
                /**
                 * Static representation of the {@link senderPubSecBudgetPeriod} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                SENDER_PUB_SEC_BUDGET_PERIOD: fieldBuilder.buildEdmTypeField('SenderPubSecBudgetPeriod', 'Edm.String', true),
                /**
                 * Static representation of the {@link receiverPubSecFund} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                RECEIVER_PUB_SEC_FUND: fieldBuilder.buildEdmTypeField('ReceiverPubSecFund', 'Edm.String', true),
                /**
                 * Static representation of the {@link receiverPubSecFuncnlArea} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                RECEIVER_PUB_SEC_FUNCNL_AREA: fieldBuilder.buildEdmTypeField('ReceiverPubSecFuncnlArea', 'Edm.String', true),
                /**
                 * Static representation of the {@link receiverPubSecGrant} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                RECEIVER_PUB_SEC_GRANT: fieldBuilder.buildEdmTypeField('ReceiverPubSecGrant', 'Edm.String', true),
                /**
                 * Static representation of the {@link receiverPubSecBudgetPeriod} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                RECEIVER_PUB_SEC_BUDGET_PERIOD: fieldBuilder.buildEdmTypeField('ReceiverPubSecBudgetPeriod', 'Edm.String', true),
                /**
                 * Static representation of the {@link personWorkAgreementExternalI} property for query construction.
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                PERSON_WORK_AGREEMENT_EXTERNAL_I: fieldBuilder.buildEdmTypeField('PersonWorkAgreementExternalI', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                TIME_SHEET_RECORD: fieldBuilder.buildEdmTypeField('TimeSheetRecord', 'Edm.String', true),
                /**
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                PARENT_UUID: fieldBuilder.buildEdmTypeField('ParentUUID', 'Edm.String', true),
                ...this.navigationPropertyFields,
                /**
                 *
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', Yy1_Dummyprojecttime3_1.Yy1_Dummyprojecttime3)
            };
        }
        return this._schema;
    }
}
exports.Yy1_Dummyprojecttime3Api = Yy1_Dummyprojecttime3Api;
//# sourceMappingURL=Yy1_Dummyprojecttime3Api.js.map