 ...
 */
export class Yy1_CurrentUserApi2RequestBuilder<
...
> extends RequestBuilder<Yy1_CurrentUserApi2<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_CurrentUserApi2<T>, T> {
    return new GetAllRequestBuilder<Yy1_CurrentUserApi2<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_CurrentUserApi2<T>, T>(
      this.entityApi,
      { UserID: userId }
    );
  }
