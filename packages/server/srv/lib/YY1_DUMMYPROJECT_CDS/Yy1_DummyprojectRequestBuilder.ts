 ...
 */
export class Yy1_DummyprojectRequestBuilder<
...
> extends RequestBuilder<Yy1_Dummyproject<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_Dummyproject<T>, T> {
    return new GetAllRequestBuilder<Yy1_Dummyproject<T>, T>(this.entityApi);
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<Yy1_Dummyproject<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_Dummyproject<T>, T>(this.entityApi, {
      SAP_UUID: sapUuid
    });
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<Yy1_Dummyproject<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(sapUuidOrEntity: any): DeleteRequestBuilder<Yy1_Dummyproject<T>, T> {
    return new DeleteRequestBuilder<Yy1_Dummyproject<T>, T>(
      this.entityApi,
      sapUuidOrEntity instanceof Yy1_Dummyproject
        ? sapUuidOrEntity
