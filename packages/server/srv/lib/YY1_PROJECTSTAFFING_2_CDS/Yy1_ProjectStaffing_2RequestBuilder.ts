 ...
 */
export class Yy1_ProjectStaffing_2RequestBuilder<
...
> extends RequestBuilder<Yy1_ProjectStaffing_2<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<Yy1_ProjectStaffing_2<T>, T> {
    return new GetAllRequestBuilder<Yy1_ProjectStaffing_2<T>, T>(
      this.entityApi
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<Yy1_ProjectStaffing_2<T>, T>(
      this.entityApi,
      { ID: id }
    );
  }
